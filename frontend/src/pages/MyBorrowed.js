    ...
    <div className="page">
      <div className="page-header">
        <div>
          ...
          <p className="subhead">Track active borrowed books, due dates, and past returns in one place.</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <>
          <section className="panel">
            <h2>Active Borrowed ({active.length})</h2>
            {active.length === 0 ? (
              <p className="muted">No active borrowed books.</p>
            ) : (
